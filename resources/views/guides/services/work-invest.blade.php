            ...
            <div class="container">
                <div class="service-hero__row">
                    <div class="service-hero__content">
                        <span class="service-hero__badge">Stage 03. Work & Invest</span>
                        <h1>Work & Invest: Build Your Future</h1>
                        <p class="service-hero__subhead">
                            Beyond settling in, our ‘Work & Invest’ services are designed to help you thrive professionally and financially in Australia or New Zealand.
                        </p>
            ...
            <div class="container">
                <div class="flagship-body__row">
                    ...
                    <div class="flagship-details">
                        <h2 class="flagship-details__title">Thrive Professionally & Financially</h2>
                        <p class="flagship-details__intro">
                            Establish your professional standing, optimize your career prospects, and secure your long-term financial foundations in Australia or New Zealand.
                        </p>
                        ...
                        <div class="flagship-timeline">
                            <div class="flagship-timeline__item">
                                ...
                                <span class="flagship-timeline__phase">Phase 01: Job Market Alignment</span>
                                <h3 class="flagship-timeline__title">Resume Optimization & Job Search Strategy</h3>
                                <p class="flagship-timeline__desc">
                                    Localize your resume and cover letters to match Australian/NZ corporate standards, optimize your LinkedIn profile, and map out target companies.
                                </p>
                            </div>
                            <div class="flagship-timeline__item">
                                <div class="flagship-timeline__bullet"></div>
                                <span class="flagship-timeline__phase">Phase 02: Career Integration</span>
                                <h3 class="flagship-timeline__title">Interview Coaching & Networking</h3>
                                <p class="flagship-timeline__desc">
                                    3 mock interview sessions to build confidence for local workplace behavioral assessments and guidance on building local industry connections.
                                </p>
                            </div>
                            <div class="flagship-timeline__item">
                                <div class="flagship-timeline__bullet"></div>
                                <span class="flagship-timeline__phase">Phase 03: Financial Building</span>
                                <h3 class="flagship-timeline__title">Tax, Pension & Wealth Overview</h3>
                                <p class="flagship-timeline__desc">
                                    Deep dive sessions into local taxation structures, superannuation plans, small business legal registrations, and property investment metrics.
                                </p>
                            </div>
                        </div>

                        <!-- Grid Showcase of Inclusions -->
                        <h3 class="flagship-inclusions__title">Everything Included in Your Work & Invest Support</h3>
                        <div class="flagship-inclusions__grid">
                            <div class="flagship-inclusion__card">
                                ...
                                <h4 class="flagship-inclusion__card-title">Local Job Market Insights</h4>
                                <p class="flagship-inclusion__card-desc">Understand industry trends, in-demand skills, and effective job search strategies.</p>
                            </div>
                            <div class="flagship-inclusion__card">
                                <div class="flagship-inclusion__icon-box">
                                ...
                                <h4 class="flagship-inclusion__card-title">Resume & Cover Letter Optimization</h4>
                                <p class="flagship-inclusion__card-desc">Tailor your application documents and CV to meet local recruiter expectations and standards.</p>
                            </div>
                            <div class="flagship-inclusion__card">
                                <div class="flagship-inclusion__icon-box">
                                    <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                                </div>
                                <h4 class="flagship-inclusion__card-title">Interview Coaching</h4>
                                <p class="flagship-inclusion__card-desc">Prepare for local interview styles, cultural expectations, and 3 intensive mock interview coaching sessions.</p>
                            </div>
                            <div class="flagship-inclusion__card">
                                <div class="flagship-inclusion__icon-box">
                                ...
                                <h4 class="flagship-inclusion__card-title">Professional Networking Strategies</h4>
                                <p class="flagship-inclusion__card-desc">Guidance on building valuable connections in your field, including full LinkedIn profile optimization.</p>
                            </div>
                            <div class="flagship-inclusion__card">
                                <div class="flagship-inclusion__icon-box">
                                    <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                                </div>
                                <h4 class="flagship-inclusion__card-title">Understanding Workplace Culture</h4>
                                <p class="flagship-inclusion__card-desc">Navigate local office dynamics, professional etiquette, and communication styles with confidence.</p>
                            </div>
                            <div class="flagship-inclusion__card">
                                <div class="flagship-inclusion__icon-box">
                                ...
                                <h4 class="flagship-inclusion__card-title">TFN/IRD & Superannuation</h4>
                                <p class="flagship-inclusion__card-desc">Ensure your employment setups, pensions, tax file numbers, and financial foundations are correctly established.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flagship-sidebar">
                        ...
                        <div class="flagship-sticky-card">
                            ...
                            <div class="flagship-sticky-card__body">
                                ...
                                <h3 class="flagship-sticky-card__title">Package 4: Career Kickstart & Professional Integration</h3>
                                <p class="flagship-sticky-card__tagline">Unlock your career potential in your new country.</p>
                                ...
                                <button class="package-cta-btn" type="button"
                                    ...
                                    data-package-number="4"
                                    data-package-stage="Stage 03. Work & Invest: Build Your Future"
                                    data-package-headline="Career Kickstart & Professional Integration"
                        ...
                        <div class="flagship-sticky-card">
                            ...
                            <div class="flagship-sticky-card__body">
                                ...
                                <h3 class="flagship-sticky-card__title">Package 5: Financial Foundations & Investment Guidance</h3>
                                <p class="flagship-sticky-card__tagline">Secure your financial future in Australia or New Zealand.</p>
                                
                                <ul class="flagship-checklist">
                                    <li class="flagship-checklist__item">
                                        <svg class="flagship-checklist__icon" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                        Credit Score Setup Guidance
                                    </li>
                                    <li class="flagship-checklist__item">
                                        <svg class="flagship-checklist__icon" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                ...
                                <div class="flagship-sticky-card__price-box">
                                    <span class="flagship-sticky-card__price-label">Program Investment</span>
                                    <span class="flagship-sticky-card__price-val">$1,999 AUD</span>
                                </div>

                                <button class="package-cta-btn" type="button"
                                    data-open-package-modal
                                    data-package-number="5"
                                    data-package-stage="Stage 03. Work & Invest: Build Your Future"
                                    data-package-headline="Financial Foundations & Investment Guidance"
                                    data-package-price="$1,999 AUD">
                                    Build Your Wealth
                                </button>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="trust-strip__row">
                    <div class="trust-strip__item">
                        <div class="trust-strip__value">85%</div>
                        <div class="trust-strip__label">Job Placement Rate</div>
                    </div>
                    <div class="trust-strip__item">
                        <div class="trust-strip__value">6 Weeks</div>
                        <div class="trust-strip__label">Average Time To Offer</div>
                    </div>
                    <div class="trust-strip__item">
                        <div class="trust-strip__value">Top-Tier</div>
                        <div class="trust-strip__label">Financial Partners</div>
                    </div>
                </div>
            </div>
        </section>
