                    ...
                    <div class="migration-form-section__panel">
                        ...
                        <form class="lead-form migration-form migration-form--pro" method="POST" action="{{ route('lead-capture.store') }}">
                            ...
                            <div class="migration-form__grid migration-form__grid--pro">
                                ...
                                <div class="migration-form__row">
                                    <label class="migration-form__field"><span>Current Visa Status</span><select class="pro-select" name="current_visa_status" required><option value="">Select one</option><option value="Student" @selected(old('current_visa_status') === 'Student')>Student</option><option value="Working Holiday" @selected(old('current_visa_status') === 'Working Holiday')>Working Holiday</option><option value="Partner" @selected(old('current_visa_status') === 'Partner')>Partner</option><option value="Skilled" @selected(old('current_visa_status') === 'Skilled')>Skilled</option><option value="Visitor" @selected(old('current_visa_status') === 'Visitor')>Visitor</option><option value="Other" @selected(old('current_visa_status') === 'Other')>Other</option></select>@error('current_visa_status')<small>{{ $message }}</small>@enderror</label>
                ...
                <div class="booking-modal__form-wrap">
                    <form class="booking-form" method="POST" action="{{ route('lead-capture.store') }}" data-async-form data-success-target="booking-form-success" novalidate>
                        ...
                        <div class="booking-form__split">
                            ...
                            <label><span>Preferred Time</span><select class="pro-select" name="preferred_time" required><option value="">Select time</option><option value="09:00 AM - 11:00 AM">09:00 AM - 11:00 AM</option><option value="11:00 AM - 01:00 PM">11:00 AM - 01:00 PM</option><option value="02:00 PM - 04:00 PM">02:00 PM - 04:00 PM</option><option value="05:00 PM - 07:00 PM">05:00 PM - 07:00 PM</option></select></label>
                        </div>
                        <label><span>Consultation Format</span><select class="pro-select" name="consultation_format" required><option value="">Select format</option><option value="Google Meet">Google Meet</option><option value="Zoom">Zoom</option><option value="Phone Call">Phone Call</option></select></label>
