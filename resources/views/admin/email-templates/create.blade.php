        ...
        <section class="admin-panel-card">
            <div class="admin-settings-section">
                ...
                <div class="admin-form-grid">
                    ...
                    <label class="admin-form-grid__full">
                        <span>HTML Body *</span>
                        <textarea name="body_html" rows="15" required class="w-full border rounded px-3 py-2 font-mono text-sm @error('body_html') border-red-500 @enderror">{{ old('body_html', $defaultBodyHtml) }}</textarea>
                    ...
                    <label class="admin-form-grid__full">
                        ...
                        <textarea name="body_text" rows="8" class="w-full border rounded px-3 py-2 font-mono text-sm @error('body_text') border-red-500 @enderror">{{ old('body_text') }}</textarea>
