...
create_symlink "$APP_DIR/public/favicon-16x16.png"    "$WEB_ROOT/favicon-16x16.png"    "favicon-16x16.png"
create_symlink "$APP_DIR/public/favicon-32x32.png"    "$WEB_ROOT/favicon-32x32.png"    "favicon-32x32.png"
create_symlink "$APP_DIR/public/favicon-48x48.png"    "$WEB_ROOT/favicon-48x48.png"    "favicon-48x48.png"
create_symlink "$APP_DIR/public/favicon-64x64.png"    "$WEB_ROOT/favicon-64x64.png"    "favicon-64x64.png"
create_symlink "$APP_DIR/public/favicon-96x96.png"    "$WEB_ROOT/favicon-96x96.png"    "favicon-96x96.png"
create_symlink "$APP_DIR/public/favicon-128x128.png"  "$WEB_ROOT/favicon-128x128.png"  "favicon-128x128.png"
